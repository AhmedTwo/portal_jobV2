...
class Offer
{
    ...
    public function findAll()
    {
        ...
        e.name AS contrat, c.name AS nom_company
        FROM job_offers 
    ...
    public function findOffersByLimit($limit)
    {
        $sql = "
        SELECT j.*,
               c.id AS id_company,
               ...
               e.name AS contrat,
               c.name AS nom_company
        FROM job_offers j
        JOIN company AS c ON j.id_company = c.id
    ...
    public function readOfferCompany($id)
    {

        $id = (int) $id; // Nettoyage de l'ID pour éviter des injections SQL
    ...
    public function offerDetailCompany($id)
    {
    ...
    public function addOffers()
    {
        ...
        return $pdostmt->execute([
            ...
            ":technologie" => $this->technologies_used,
    ...
    public function updateOfferInDB($data)
    {
        $query = "
     ...
     * @return  self
     */
    public function setTechnologies($technologies_used)
    {
