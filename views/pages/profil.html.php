<?php if ($profilData): ?>
    ...
    <div class="profil-container">
        ...
        <div class="profil-info">
            ...
            <p><span>CV :</span> <a href="/includes/uploads/cv/<?= urlencode(basename($profilData['cv_pdf'])) ?>" target="_blank">Voir le CV</a></p>
            <!-- ✅ urlencode() s'assure que le nom du fichier est bien lu même s’il contient des caractères spéciaux. -->
            <!-- <?php var_dump($profilData['cv_pdf']); ?> -->
...
<?php else: ?>
    <h1 style="text-align: center; margin-top: 6rem;">Vous devez être connecté pour voir votre profil !!</h1>
<?php endif; ?>