            ...
            <?php foreach ($offers as $offer): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="../../includes/delete.php?idO=<?= $offer['id'] ?>"
                            class="btn btn-danger"
                            title="Supprimer"
                            onclick="return confirm('Es-tu sûr de vouloir supprimer ce User ?')">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
<div>
    ...
    <table id="idTable">
        ...
        <tbody>
            <?php foreach ($companys as $comapny): ?>
                <tr>
                    <td><?= htmlspecialchars($comapny['id']) ?></td>
                    <td><?= htmlspecialchars($comapny['name']) ?></td>
                    <td><?= htmlspecialchars($comapny['address']) ?></td>
                    ...
                    <td>
                        ...
                        <a href="../../includes/delete.php?idC=<?= $comapny['id'] ?>"
                            class="btn btn-danger"
                            title="Supprimer"
                            onclick="return confirm('Es-tu sûr de vouloir supprimer ce User ?')">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
